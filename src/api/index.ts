...
import BasePPProductTypesAPI from "./product/pp_product_types.api";
...
export const PPProductTypesAPI = new BasePPProductTypesAPI(`${BASE_URL}/${ENTITIES_ENDPOINTS.pp_product_types}`);
